    ...
    <div class="row justify-content-between">
      ...
      <div class="col-md-5 col-lg-5 col-xl-5">
            ...
            <div class="row">
              <div class="col-7">
                <div class="text-primary p-4">
                  ...
                  <p>Silahkan Masuk Untuk Melanjutkan Ujian.</p>
                </div>
              </div>
            ...
            <b-form class="p-2" @submit.prevent="tryToLogIn">
              ...
              <div class="mt-4 text-center">
                <router-link tag="a" to="/forgot-password" class="text-muted">
                  <i class="mdi mdi-lock mr-1"></i> Lupa Password?
                </router-link>
              </div>
            </b-form>
          </div>
        ...
        <div class="mt-5 text-center">
          <p>
            Belum Memiliki Akun ?
            <router-link tag="a" to="/register" class="font-weight-medium text-primary">Daftar Disini</router-link>
          </p>
          <p>
